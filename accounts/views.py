...
class StudentCreationView(LoginRequiredMixin, CreateView):
    template_name = 'accounts/students/create.html'
    model = Student
    fields = "__all__"
...
class StudentDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        u_user = Teacher.objects.get(pk=self.kwargs["pk"])
...
# def export_student_view(request):
